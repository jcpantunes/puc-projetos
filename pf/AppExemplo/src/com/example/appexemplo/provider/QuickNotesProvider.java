 ...
 * 
 */
package com.example.appexemplo.provider;
...
public class QuickNotesProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.example.appexemplo.provider.quicknotesprovider";
	...
	private static class DBHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("CREATE TABLE " + NOTES_TABLE + " (" + Notes.NOTE_ID
					+ " INTEGER PRIMARY KEY AUTOINCREMENT," + Notes.TEXT
					+ " LONGTEXT" + ");");
		}

...
public interface CamelService {
    ...
    NotaWSDTO recuperarNotaAluno(String matriculaAluno, String codigoDisciplina);
    
    ListaNotaWSDTO recuperarHistoricoAluno(String matricula);
    
    SolicitacaoTrancamentoMatriculaWSDTO solicitarTrancamento(String matricula, String codigoDisciplina);
    
    ListaResultadoTrancamentoMatriculaWSDTO confirmarSolicitacao();
